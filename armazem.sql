...
CREATE TABLE locais_armazenagem (
  ...
  codigo_local     VARCHAR(60)     NOT NULL,              -- ex.: RUA-A/PRAT-03/POS-02
...
CREATE TABLE unidades_medida (
  ...
  sigla       VARCHAR(10)     NOT NULL,   -- UN, CX, KG, L
...
CREATE TABLE movimentacoes_estoque (
  ...
  quantidade        DECIMAL(18,3)   NOT NULL,  -- sempre positiva
  realizado_por     BIGINT UNSIGNED NOT NULL,  -- FK usuários
...
-- =========================
-- Saldo total por produto (somando todos os locais)
...
-- =========================
-- 8) (Opcional) Dados de exemplo rápidos
-- =========================
INSERT INTO usuarios (nome_completo, email, senha_hash, salt) VALUES
('Admin', 'admin@techstorage.local', 'hash_demo', 'salt_demo');
...
-- Zera saldos e define quantidade inicial por local
